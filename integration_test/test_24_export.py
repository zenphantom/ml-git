...
class ExportTagAcceptanceTests(unittest.TestCase):
    ...
    def test_01_export_tag(self):
        ...
        self.assertIn(messages[61] % (tag, store, "s3://mlgit"), check_output("ml-git dataset export {} {} --credentials={} --endpoint=http://127.0.0.1:9000".format(tag, BUCKET_NAME, PROFILE)))
