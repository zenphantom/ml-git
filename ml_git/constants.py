...
STORAGE_FACTORY_CLASS_NAME = 'Store Factory'
...
S3STORAGE_NAME = 'S3Store'
AZURE_STORAGE_NAME = 'AzureStore'
S3_MULTI_HASH_STORAGE_NAME = 'S3MultihashStore'
MULTI_HASH_STORAGE_NAME = 'MultihashStore'
HEAD = 'HEAD'
HEAD_1 = 'HEAD~1'
...
TAG = 'Tag'
GDRIVE_STORAGE = 'GOOGLE_DRIVE_STORE'
