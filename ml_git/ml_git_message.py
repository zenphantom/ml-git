...
output_messages = {
    ...
    'DEBUG_TAG_CHECK_REPOSITORY': 'Repository: check if tag already exists',
    ...
    'DEBUG_REMOVING_MESAGE': 'Removing %s',
    ...
    'ERROR_ENTITY_CATATEGOY': 'You must place at least one category in the entity .spec file',
    'ERROR_INVALID_DATASET_SPEC': 'Error: invalid dataset spec (Missing name). It should look something like this:\n%s',
    'ERROR_NO_REPOSITORY_FOUND': 'No repositories found, verify your configurations!',
    ...
    'ERROR_ERROR_TO_FETCH_FILE': 'Error to fetch file -- [%s]',
    'ERROR_FSCK_TO_IPLD': 'LocalRepository: Error to fsck ipld -- [%s]',
    'ERROR_FSCK_BLOB': 'LocalRepository: Error to fsck blob -- [%s]',
    'ERROR_REMOTE_FSCK_UNFIXED': 'remote-fsck -- unfixed : ipld[%d] / blob[%d]',
    'ERROR_DISCARTED_LOCAL_CHANGES': 'Your local changes to the following files would be discarded: ',
    'ERROR_FATAL_DOWNLOADING': 'Fatal downloading error [%s]',
    'ERROR_EXPORT_FILES': 'Error to export files -- [%s]',
    'ERROR_MESSAGE': '%s',
    'ERROR_PUSH_METADATA': 'Error on push metadata to git repository. Please update your mlgit project!',
