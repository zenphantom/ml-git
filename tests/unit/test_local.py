...
class LocalRepositoryTestCases(unittest.TestCase):
    ...
    def test_add_metrics(self):
        ...
        model = spec_file['dataset'].copy()
        del spec_file['dataset']
        spec_file['model'] = model
        ...
        self.assertTrue(test_spec_file['model']['metrics'].get('metric_a', '') == 10.0)
        self.assertTrue(test_spec_file['model']['metrics'].get('metric_b', '') == 9.0)
    ...
    def test_add_metrics_wrong_entity(self):
        ...
        local_repo.add_metrics(spec_path, (('metric_a', '10'), ('metric_b', '9')), None)
        test_spec_file = yaml_load(spec_path)
        self.assertFalse('metrics' in test_spec_file['dataset'])
    ...
    def test_add_metrics_with_none_metrics_options(self):
        ...
        test_spec_file = yaml_load(spec_path)
        self.assertFalse('metrics' in test_spec_file['model'])
    ...
    def test_add_metrics_file(self):
        ...
        test_spec_file = yaml_load(spec_path)
        self.assertEqual(test_spec_file['model']['metrics'].get('metric_a', ''), 10.0)
        self.assertEqual(test_spec_file['model']['metrics'].get('metric_b', ''), 9.0)
