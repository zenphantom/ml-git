...
from tests.integration.helper import ML_GIT_DIR, GIT_PATH, \
    GIT_WRONG_REP, BUCKET_NAME, PROFILE, STORAGE_TYPE, GLOBAL_CONFIG_PATH, delete_global_config
...
class InitEntityAcceptanceTests(unittest.TestCase):
    ...
    def set_up_init(self, entity_type, git=GIT_PATH):
        ...
        self.assertIn(messages[7] % (STORAGE_TYPE, BUCKET_NAME, PROFILE), check_output(MLGIT_STORAGE_ADD % (BUCKET_NAME, PROFILE)))
